...
pub(crate) static DB_PATH: OnceCell<PathBuf> = OnceCell::INIT;
...
// let mut stmt = conn.prepare(include_str!("../sql/youtube/get_previous.sql"))?;
// let mut stmt = conn.prepare(include_str!("../sql/youtube/get_all.sql"))?;
